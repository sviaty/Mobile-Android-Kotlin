...
class KeyStoreEncryptDecrypt(context: Context) {
    ...
    private val KEY_ALIAS = "YOUR-KeyAliasForEncryption"
    ...
    private val SHARED_PREFERENCE_NAME = "YOUR-EncryptedKeysSharedPreferences"
    private val ENCRYPTED_KEY_NAME = "YOUR-EncryptedKeysKeyName"
    private val LOG_TAG = KeyStoreEncryptDecrypt::class.java.name
    ...
    private fun removeSavedSharedPreferences() {
        ...
        val clearedPreferencesSuccessfully = preferences.edit().clear().commit()
...
//        }
    ...
    fun encryptData(stringDataToEncrypt: String?): String {
        ...
        val encodedBytes = cipher.doFinal(stringDataToEncrypt.toByteArray())
    ...
    fun decryptData(encryptedData: String?): String {
        ...
        try {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                c.init(Cipher.DECRYPT_MODE, getSecretKeyAPIMorGreater(), GCMParameterSpec(128, FIXED_IV))
            } else {
